...
export default function Stack2(stackID, zone) {
  ...
  return (
    ...
    <Grid container spacing={0.5} mb={1}>
      <Grid item xs={0.7} onClick={e => console.log("L9FDUBG139N4048169")}>
        <Fab size="small"  
          color={selectedCell == "L9FDUBG139N4048169" ? "#2e7d32" : "success"}
          aria-label="add" >
