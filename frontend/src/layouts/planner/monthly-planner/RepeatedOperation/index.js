...
export default function RepeatedOperation(dateValue) {
  ...
  console.log("Data table data", dataTableData.rows)
  ...
  return (
    <Card>
      <CardHeader
        ...
        subheader={<MDTypography style={{color: 'green', fontSize: '14px', paddingTop: '1%'}}>{dataTableData.rows.length} components scheduled</MDTypography>}
        />
      {!toggleEnable ? 
